...
the last hidden state through 0.20 dropout and a $48\rightarrow3$ softmax head. Weighted
cross-entropy, Adam ($10^{-3}$), batch size 256, gradient clipping at 1.0, at most 12 epochs, and
validation-loss patience 3 were used. Seeds 42--44 quantify variation; minimum validation loss
selected seed 43 before prospective access.
...
\midrule
Majority & 0.216 & 0.481 & 0.243 & \textbf{0.573}\\
Momentum & 0.380 & 0.421 & 0.356 & 0.447\\
Logistic regression & \textbf{0.429} & \textbf{0.480} & 0.380 & 0.529\\
